    ...
    if (contactForm) {
      ...
      contactForm.addEventListener('submit', function(e) {
        ...
        if (isValid) {
          ...
          const successMsg = contactForm.querySelector('.form-success') || createSuccessMessage();
          ...
          if (contactForm.getAttribute('action')) {
            ...
            fetch(contactForm.getAttribute('action'), {
              ...
              // Silent fail - success message already shown
            });
          }
        }
      });
      ...
      function validateField(field) {
        ...
        // Email validation
        if (valid && (type === 'email' || field.name === 'email')) {
        ...
        // Phone validation
        if (valid && (type === 'tel' || field.name === 'phone')) {
          const phoneRegex = /^[\d\s\-\+\(\)]{7,}$/;
          if (value && !phoneRegex.test(value)) {
            errorMsg = field.getAttribute('data-error-phone') || 'Please enter a valid phone number';
            valid = false;
          }
        }

        // Min length
        if (valid && field.hasAttribute('minlength') && value.length < parseInt(field.getAttribute('minlength'))) {
          errorMsg = field.getAttribute('data-error-minlength') || 'Minimum ' + field.getAttribute('minlength') + ' characters required';
          valid = false;
        }

        // Show/hide error
        toggleFieldError(field, valid, errorMsg);
        return valid;
      }

      function toggleFieldError(field, valid, message) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'c7679144-5b18-412c-8794-fb5c6d7a556e',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'c7679144-5b18-412c-8794-fb5c6d7a556e';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'c7679144-5b18-412c-8794-fb5c6d7a556e';
